...
**Location**: `data/gold/states/{STATE}/events_event_participants.parquet`
...
python -c "
import polars as pl
df = pl.read_parquet('data/gold/states/AL/events_event_participants.parquet')
...
for state in states:
    df = pl.read_parquet(f'data/gold/states/{state}/events_event_participants.parquet')
...
│   │   ├── events_event_participants.parquet   # Event participants ✅
...
events = pl.read_parquet('data/gold/states/AL/events_event_participants.parquet')
print(events.head())
```
