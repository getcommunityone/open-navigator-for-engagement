...
# Gemma Edge / 3n (only when listed on the key — many Gemma-4-only projects omit these).
...
# Gemini accepts audio/video on standard AI Studio keys (use when Gemma Edge is unavailable).
