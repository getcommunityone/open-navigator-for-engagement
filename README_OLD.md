...
- **[📖 Full Documentation](http://localhost:3000)** - Complete guides, architecture, and API reference
- **[⚛️ Open Navigator App](http://localhost:5173)** - Main application interface
- **[🔥 API Docs](http://localhost:8000/docs)** - FastAPI interactive documentation

## What It Does

Analyzes municipal meeting minutes and financial documents to identify oral health advocacy opportunities using multi-agent AI. Features include automated scraping, policy classification, sentiment analysis, and advocacy material generation.

**For detailed information** about features, data sources, and integrations, see the **[full documentation site](http://localhost:3000)**.
