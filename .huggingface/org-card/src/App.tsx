          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <button
                ...
                className={`text-sm font-medium transition-colors ${activeSection === 'home' ? 'text-primary-600' : 'text-gray-600 hover:text-gray-900'}`}
              >
                Home
              </button>
              <button
                onClick={() => setActiveSection('datasets')}
                className={`text-sm font-medium transition-colors ${activeSection === 'datasets' ? 'text-primary-600' : 'text-gray-600 hover:text-gray-900'}`}
              >
                Datasets
              </button>
              <button
                onClick={() => setActiveSection('about')}
                className={`text-sm font-medium transition-colors ${activeSection === 'about' ? 'text-primary-600' : 'text-gray-600 hover:text-gray-900'}`}
              >
                About
              </button>
              <a
